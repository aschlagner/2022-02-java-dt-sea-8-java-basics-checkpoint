...
public class TestExpireablesLoader {
    ...
    public void testExpireablesLoader() {
        ...
        assertEquals(8, database.getList().size(), "1) There should be eight entries in the list.");
        boolean found = false;
        ...
        assertTrue(found, "2) The entry with the expiration date of 2022-06-18 should be loaded from file and therefore be in the list.");
    }
}
